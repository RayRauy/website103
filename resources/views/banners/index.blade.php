                                                ...
                                                @php ($i=1)                                                 
                                                    @foreach ($rows as $row)                                                      
                                                        <tr>
                                                            ...
                                                            <td class="text-end">  
                                                                <a href="{{ route('banner.edit',$row->id) }}"><i class="las la-pen text-secondary fs-18"></i></a>
                                                                <a href="{{ route('banner.delete',$row->id) }}"><i class="las la-trash-alt text-secondary fs-18"></i></a>
                                                            </td>
                                                        </tr>                                                                                                     
                                                @endforeach                                              
                                            @endif                                                                                 
