            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('create_news') }}">Create News</a></li>
                            <li><a class="dropdown-item" href="{{ route('create_news') }}">Edit News</a></li>
                            <li><a class="dropdown-item" href="{{ route('create_news') }}">Show News</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('test') }}">Testing</a>
                    </li>
                </ul>
                <form class="d-flex">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{route('contacts')}}" class="text-white text-decoration-none">Contact</a></li>
